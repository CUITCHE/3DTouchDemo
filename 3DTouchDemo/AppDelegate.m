...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    _rootViewController = [[UINavigationController alloc] initWithRootViewController:[[ViewController alloc] init]];
...
- (void)application:(UIApplication *)application performActionForShortcutItem:(UIApplicationShortcutItem *)shortcutItem completionHandler:(void (^)(BOOL))completionHandler
{
    ...
    // type 就是 shortcut item的唯一id
    if ([shortcutItem.type isEqualToString:@"com.che.homePage"]) {
        message = @"首页Action被点击";
    } else if ([shortcutItem.type isEqualToString:@"com.che.search"]) {
        message = @"搜索Action被点击";
    }
